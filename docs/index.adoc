...
Selenwright is a powerful http://golang.org/[Golang] implementation of original http://github.com/SeleniumHQ/selenium[Selenium] hub code.
...
include::selenwright-without-docker.adoc[leveloffset=+1]
