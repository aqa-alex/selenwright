...
----
const browser = await browserType.connect(
  `wss://selenwright.example.com/playwright/chromium/1.44.1?token=${process.env.SELENWRIGHT_TOKEN}`
);
----
...
----
ws://host:4444/playwright/chromium/1.44.1?enableVNC=true&name=myTest&screenResolution=1280x1024
----
